...
#Create Edit Function to save teh edited record.
def update():
	#create a database or connect to one
	conn = sqlite3.connect('address_book.db')
	# Create Cursor
...
def edit():
	...
	editor.iconbitmap('Martz90-Circle-Camera.ico')
	...
	#create Global Varibles for text box names
	...
	#Creae a Save Button to Save edited record
